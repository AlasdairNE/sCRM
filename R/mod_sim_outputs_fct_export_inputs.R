      ...
      spp_in_wf_inputs <- 
        list(
          ...
          inflight_features = tibble::tibble(
            ...
            macro_avoid_mean = inflight_ftrs$macro_avoid$mean,
            macro_avoid_sd = inflight_ftrs$macro_avoid$sd,
            meso_avoid_mean = inflight_ftrs$meso_avoid$mean,
            meso_avoid_sd = inflight_ftrs$meso_avoid$sd,
